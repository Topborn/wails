...
__export(index_exports, {
  ...
  WailsWebViewElement: () => WailsWebViewElement,
...
// desktop/@wailsio/runtime/src/protocol.generated.ts
...
var embeddedWebViewMethods = Object.freeze({
  Create: 0,
  Destroy: 1,
  SetBounds: 2,
  SetVisible: 3,
...
// desktop/@wailsio/runtime/src/embedded_webview.ts
var HTMLElementBase = hasDOM ? HTMLElement : class {
};
var caller = newRuntimeCaller(objectNames.EmbeddedWebView);
var elementsByID = /* @__PURE__ */ new Map();
var pendingLayout = /* @__PURE__ */ new Set();
...
function flushLayout() {
  ...
  for (const element of batch) void element.syncLayout((_a3 = order.get(element)) != null ? _a3 : 0);
}
var stackingCandidates = /* @__PURE__ */ new Set();
function createsStackingContext(style, parentStyle) {
...
function classifyStacking(element) {
...
function scanStacking(root) {
  if (!(root instanceof Element)) return;
  classifyStacking(root);
  for (const element of root.querySelectorAll("*")) classifyStacking(element);
}
function paintKey(element, context) {
  let item = element;
  for (let e = element; e && e !== context; e = e.parentElement) {
...
function comparePaint(a, b) {
  if (a.layer !== b.layer) return a.layer - b.layer;
  if (a.z !== b.z) return a.z - b.z;
  if (a.element === b.element) return 0;
  return a.element.compareDocumentPosition(b.element) & Node.DOCUMENT_POSITION_FOLLOWING ? -1 : 1;
}
function paintsAbove(candidate, guest) {
...
function dropContained(rects) {
  return rects.filter((rect, i) => !rects.some((other, j) => j !== i && other[4] === 0 && rect[0] >= other[0] && rect[1] >= other[1] && rect[0] + rect[2] <= other[0] + other[2] && rect[1] + rect[3] <= other[1] + other[3] && // Identical boxes: keep the first.
  !(rect[0] === other[0] && rect[1] === other[1] && rect[2] === other[2] && rect[3] === other[3] && rect[4] === 0 && j > i)));
}
function overlayExclusions(guest, bounds) {
  const rects = [];
  for (const candidate of stackingCandidates) {
    ...
    for (const rect of candidate.getClientRects()) {
      ...
      above != null ? above : above = paintsAbove(candidate, guest);
      if (!above) break;
      const whole = left === Math.floor(rect.left) && top === Math.floor(rect.top) && right === Math.ceil(rect.right) && bottom === Math.ceil(rect.bottom);
...
function cornerRadius(style, rect) {
  const values = [
...
function isVisible2(element, bounds) {
...
function sameBounds(left, right) {
  return left !== null && left.x === right.x && left.y === right.y && left.width === right.width && left.height === right.height;
}
var _id, _creating, _lastBounds, _lastVisible, _lastZIndex, _lastExclusions, _manuallyDestroyed, _sourceSetByMethod, _disconnectGeneration, _resizeObserver, _WailsWebViewElement_instances, ensureCreated_fn, destroyNative_fn;
var WailsWebViewElement = class extends HTMLElementBase {
  constructor() {
    super(...arguments);
    __privateAdd(this, _WailsWebViewElement_instances);
    __privateAdd(this, _id, null);
    __privateAdd(this, _creating, null);
    __privateAdd(this, _lastBounds, null);
    __privateAdd(this, _lastVisible, false);
    __privateAdd(this, _lastZIndex, -1);
    __privateAdd(this, _lastExclusions, []);
    __privateAdd(this, _manuallyDestroyed, false);
    __privateAdd(this, _sourceSetByMethod, false);
    __privateAdd(this, _disconnectGeneration, 0);
  ...
  get src() {
    var _a3;
    return (_a3 = this.getAttribute("src")) != null ? _a3 : "about:blank";
  }
  set src(value) {
  ...
  get userAgent() {
    var _a3;
    return (_a3 = this.getAttribute("useragent")) != null ? _a3 : "";
  }
  set userAgent(value) {
  ...
  connectedCallback() {
    var _a3;
    __privateWrapper(this, _disconnectGeneration)._++;
    allElements.add(this);
    if (typeof ResizeObserver !== "undefined") {
      (_a3 = __privateGet(this, _resizeObserver)) != null ? _a3 : __privateSet(this, _resizeObserver, new ResizeObserver(() => requestLayout(this)));
  ...
  disconnectedCallback() {
    ...
    (_a3 = __privateGet(this, _resizeObserver)) == null ? void 0 : _a3.unobserve(this);
    const generation = ++__privateWrapper(this, _disconnectGeneration)._;
    queueMicrotask(() => {
      if (!this.isConnected && generation === __privateGet(this, _disconnectGeneration)) {
        void __privateMethod(this, _WailsWebViewElement_instances, destroyNative_fn).call(this, false, generation);
      }
    });
  }
  attributeChangedCallback(name, oldValue, newValue) {
    if (oldValue === newValue) return;
    if (name === "src" && __privateGet(this, _id) !== null && !__privateGet(this, _sourceSetByMethod)) {
      void caller(embeddedWebViewMethods.LoadURL, { id: __privateGet(this, _id), url: newValue != null ? newValue : "about:blank" });
    }
    requestLayout(this);
  }
  async loadURL(url) {
    __privateSet(this, _sourceSetByMethod, true);
    try {
      this.src = url;
    } finally {
      __privateSet(this, _sourceSetByMethod, false);
    }
    const id = await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this);
    await caller(embeddedWebViewMethods.LoadURL, { id, url });
  }
  async getURL() {
    return caller(embeddedWebViewMethods.GetURL, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async getTitle() {
    return caller(embeddedWebViewMethods.GetTitle, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async isLoading() {
    return caller(embeddedWebViewMethods.IsLoading, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async stop() {
    await caller(embeddedWebViewMethods.Stop, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async reload() {
    await caller(embeddedWebViewMethods.Reload, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async reloadIgnoringCache() {
    await caller(embeddedWebViewMethods.ReloadIgnoringCache, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async canGoBack() {
    return caller(embeddedWebViewMethods.CanGoBack, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async canGoForward() {
    return caller(embeddedWebViewMethods.CanGoForward, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async goBack() {
    await caller(embeddedWebViewMethods.GoBack, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async goForward() {
    await caller(embeddedWebViewMethods.GoForward, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async executeJavaScript(script) {
    return caller(embeddedWebViewMethods.ExecuteJavaScript, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this), script });
  }
  async openDevTools() {
    await caller(embeddedWebViewMethods.OpenDevTools, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async setZoomFactor(factor) {
    await caller(embeddedWebViewMethods.SetZoomFactor, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this), factor });
  }
  async getZoomFactor() {
    return caller(embeddedWebViewMethods.GetZoomFactor, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  async isFocused() {
    return caller(embeddedWebViewMethods.IsFocused, { id: await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this) });
  }
  focus(options) {
    super.focus(options);
    void __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this).then((id) => caller(embeddedWebViewMethods.Focus, { id }));
  }
  async destroy() {
    __privateSet(this, _manuallyDestroyed, true);
    await __privateMethod(this, _WailsWebViewElement_instances, destroyNative_fn).call(this, true);
  }
  /** @internal */
  async syncLayout(zIndex) {
    if (!this.isConnected || __privateGet(this, _manuallyDestroyed)) return;
    const bounds = nativeBounds(this);
    const visible = isVisible2(this, bounds);
    if (__privateGet(this, _id) === null) {
      if (bounds && visible) await __privateMethod(this, _WailsWebViewElement_instances, ensureCreated_fn).call(this, bounds, zIndex, visible);
      return;
    }
    const id = __privateGet(this, _id);
    const updates = [];
    if (bounds && !sameBounds(__privateGet(this, _lastBounds), bounds)) {
      __privateSet(this, _lastBounds, bounds);
      updates.push(caller(embeddedWebViewMethods.SetBounds, __spreadValues({ id }, bounds)));
    }
    if (visible !== __privateGet(this, _lastVisible)) {
      __privateSet(this, _lastVisible, visible);
      updates.push(caller(embeddedWebViewMethods.SetVisible, { id, visible }));
    }
    if (zIndex !== __privateGet(this, _lastZIndex)) {
      __privateSet(this, _lastZIndex, zIndex);
      updates.push(caller(embeddedWebViewMethods.SetZIndex, { id, zIndex }));
    }
    if (bounds) {
      const exclusions = overlayExclusions(this, bounds);
      if (!sameExclusions(__privateGet(this, _lastExclusions), exclusions)) {
        __privateSet(this, _lastExclusions, exclusions);
        updates.push(caller(embeddedWebViewMethods.SetExclusions, { id, rects: exclusions }));
      }
    }
...
_id = new WeakMap();
_creating = new WeakMap();
_lastBounds = new WeakMap();
_lastVisible = new WeakMap();
_lastZIndex = new WeakMap();
_lastExclusions = new WeakMap();
_manuallyDestroyed = new WeakMap();
_sourceSetByMethod = new WeakMap();
_disconnectGeneration = new WeakMap();
_resizeObserver = new WeakMap();
_WailsWebViewElement_instances = new WeakSet();
ensureCreated_fn = function(bounds = nativeBounds(this), zIndex = 0, visible = isVisible2(this, bounds)) {
  if (__privateGet(this, _id) !== null) return Promise.resolve(__privateGet(this, _id));
  if (__privateGet(this, _manuallyDestroyed)) return Promise.reject(new Error("embedded WebView was explicitly destroyed"));
  ...
  if (__privateGet(this, _creating)) return __privateGet(this, _creating);
  __privateSet(this, _creating, caller(embeddedWebViewMethods.Create, __spreadProps(__spreadValues({
    src: this.src,
    ...
    if (!this.isConnected || __privateGet(this, _manuallyDestroyed)) void __privateMethod(this, _WailsWebViewElement_instances, destroyNative_fn).call(this, __privateGet(this, _manuallyDestroyed));
    return result.id;
  }).finally(() => {
    __privateSet(this, _creating, null);
  }));
  return __privateGet(this, _creating);
};
destroyNative_fn = async function(explicit, disconnectGeneration) {
  const creating = __privateGet(this, _creating);
  if (creating) {
    try {
      await creating;
    } catch (e) {
  ...
  if (!explicit && disconnectGeneration !== void 0 && (this.isConnected || disconnectGeneration !== __privateGet(this, _disconnectGeneration))) return;
  const id = __privateGet(this, _id);
  if (id === null) return;
  __privateSet(this, _id, null);
  elementsByID.delete(id);
  __privateSet(this, _lastBounds, null);
  try {
    await caller(embeddedWebViewMethods.Destroy, { id });
  } finally {
    this.dispatchEvent(new CustomEvent("destroyed"));
    if (!explicit) __privateSet(this, _manuallyDestroyed, false);
  }
};
WailsWebViewElement.observedAttributes = ["src", "useragent", "hidden", "style", "class"];
function dispatchEmbeddedWebViewEvent(envelope) {
...
if (hasDOM) {
  invoke("wails:runtime:ready:" + clientId);
}
...
//# sourceMappingURL=data:application/json;base64,
